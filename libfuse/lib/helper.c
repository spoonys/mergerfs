...
static void fuse_unmount_common(const char *mountpoint, fuse_chan_t *ch)
{
  if (mountpoint) {
...
void fuse_unmount(const char *mountpoint, fuse_chan_t *ch)
{
...
static void fuse_teardown_common(struct fuse *fuse, char *mountpoint)
{
  ...
  fuse_unmount_common(mountpoint,se->ch);
  fuse_destroy(fuse);
  free(mountpoint);
}
