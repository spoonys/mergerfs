           ...
           const struct fuse_entry_param *e)
{
  ...
  arg->entry_valid      = e->timeout.entry.sec;
  arg->entry_valid_nsec = e->timeout.entry.usec;
  arg->attr_valid       = e->timeout.attr.sec;
  arg->attr_valid_nsec  = e->timeout.attr.usec;
                ...
                const fuse_timeout_t *timeout)
{
  ...
  memset(&arg,0,sizeof(arg));
  arg.attr_valid      = timeout->sec;
  arg.attr_valid_nsec = timeout->usec;
