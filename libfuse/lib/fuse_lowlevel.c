...
static int fuse_send_data_iov_fallback(struct fuse_ll *f, fuse_chan_t *ch,
...
static int fuse_send_data_iov(struct fuse_ll *f, fuse_chan_t *ch,
                              struct iovec *iov, int iov_count,
...
static int send_notify_iov(struct fuse_ll *f, fuse_chan_t *ch,
...
int fuse_lowlevel_notify_inval_inode(fuse_chan_t *ch, fuse_ino_t ino,
                                     off_t off, off_t len)
{
...
int fuse_lowlevel_notify_inval_entry(fuse_chan_t *ch, fuse_ino_t parent,
...
int fuse_lowlevel_notify_delete(fuse_chan_t *ch,
...
int
fuse_lowlevel_notify_store(fuse_chan_t              *ch,
                           fuse_ino_t                ino,
                           off_t                     offset,
                           struct fuse_bufvec       *bufv,
                           enum fuse_buf_copy_flags  flags)
...
int fuse_lowlevel_notify_retrieve(fuse_chan_t *ch, fuse_ino_t ino,
